...
class Event(models.Model):
    ...
    image = ImageField(_("Beitragsbild (Ratio: 16:9)"), upload_to='events/images/', null=True, blank=True)
    image_thumb = ImageField(_("Event Thumbnail (Ratio 1:1)"), upload_to='events/images/', null=True, blank=True)
